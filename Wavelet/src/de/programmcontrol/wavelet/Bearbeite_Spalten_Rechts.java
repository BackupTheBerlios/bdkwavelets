 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class Bearbeite_Spalten_Rechts implements Status {
	 ...
	 */
	public static final int[] folgeNr = {Lade_Matrix.Nr};
	...
	public Variablen bearbeiteStatus(Variablen variablen) {
		switch(interner_status)
		{
			...
			input = variablen.temp2Matrix;
			tieffrequent = variablen.aktueller_Subbandknoten.Daten[2];
			hochfrequent = variablen.aktueller_Subbandknoten.Daten[3];
			interner_status = ladeSpalte;
			
			Ergebniss_Hochpass = new Vektor_float(input.höhe);
			Ergebniss_Tiefpass = new Vektor_float(input.höhe);
			
			variablen.letzteYgroesse = input.höhe/2;
			...
			variablen.gui.updateObenRechts(tieffrequent);
			variablen.gui.updateUntenRechts(hochfrequent);
