 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class Bearbeite_Spalten_Links2 implements Status {
	 ...
	 */
	public static final int[] folgeNr = {Bearbeite_Spalten_Rechts2.Nr};
	...
	private void ersterlauf(){
		...
		input1 = variablen.temp_LL;
		input2 = variablen.aktueller_Subbandknoten.Daten[1];
	...
	public void update(){
		...
		variablen.temp1Matrix.addSpalte(this.Spalte+1, Vektor_Spalte_in);
		...
		if(Spalte < input1.breite){
			...
			variablen.status = new Bearbeite_Spalten_Rechts2();
		}
	}
